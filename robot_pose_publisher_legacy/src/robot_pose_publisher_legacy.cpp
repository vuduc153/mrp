...
int main(int argc, char ** argv)
{
  ...
  ros::init(argc, argv, "robot_pose_publisher_legacy");
  ros::NodeHandle nh;
  ...
  if(is_stamped)
    p_pub = nh.advertise<geometry_msgs::PoseStamped>("robot_pose_legacy", 1);
  else 
    p_pub = nh.advertise<geometry_msgs::Pose>("robot_pose_legacy", 1);
